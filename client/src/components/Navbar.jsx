    ...
    >
        ...
        >
            ...
            <Link
                to="/"
                onClick={() => setMenuOpen(false)}
                className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-2 text-green-700 font-bold text-2xl"
            >
                <img src={ravi} alt="Logo" className="h-8 w-8" />
                Home
            </Link>
        </div>
    </>
